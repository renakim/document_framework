...
![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/w7500p/peripheral/i2c_data_validity.jpg "Figure 3 Data Validity")
...
![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/w7500p/peripheral/i2c_bit_condition.jpg "Figure 4 Bit Condition")
...
![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/w7500p/peripheral/i2c_start_stop_condition.jpg "Figure 5 START and STOP Conditions")
...
![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/w7500p/peripheral/i2c_restart_condition.jpg "Figure 6 RESTART Conditions")
...
![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/w7500p/peripheral/i2c_init_flow_chart.jpg "Figure 10 I2C initial setting")

The below figure shows the master operation using a 7-bit slave address.

![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/w7500p/peripheral/i2c_tx_flow_chart.jpg "Figure 11 Master TRANSMIT with ADDR10=0 in the I2Cx_CTR")
...
![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/w7500p/peripheral/i2c_tx_repeat_flow_chart.jpg "Figure 12 Master Transmit with Repeated START")

### Slave mode

The below Figure shows the command sequences available for the I2C slave.

![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/w7500p/peripheral/i2c_slave_command_flow_chart.jpg "Figure 13 Slave Command Sequence")
