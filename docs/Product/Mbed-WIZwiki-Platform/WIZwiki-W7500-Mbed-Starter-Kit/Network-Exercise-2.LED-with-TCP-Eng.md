...
![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wizwiki_mbed_kit/kit_en/tcp_led_client_1.jpg)
...
![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wizwiki_mbed_kit/kit_en/tcp_led_server_1.jpg)
...
figure below.
![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wizwiki_mbed_kit/kit_en/tcp_led_on_client.jpg)
...
![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wizwiki_mbed_kit/kit_en/tcp_led_on_off.png)
...
![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wizwiki_mbed_kit/kit_en/tcp_led_on_server.jpg)

If **"Any messsage"**(ex: TEST) except the "LED\_ON" message to the
WIZwiki board (TCP Server), then the LED turns off.

![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wizwiki_mbed_kit/kit_en/tcp_led_off_client.jpg)
...
![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wizwiki_mbed_kit/kit_en/tcp_led_off_server.jpg)
