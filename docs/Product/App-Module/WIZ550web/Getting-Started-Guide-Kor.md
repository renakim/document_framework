...
![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wiz550web/wiz550web_front.png)
...
![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wiz550web/sdcard/sandisk-4gb-micro-sd-memory-card.mobiles_productpage.left.png)
...
![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wiz550web/sdcard/sdcard_select_format_box.jpg)

![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wiz550web/sdcard/sdcard_format_process_box.jpg)

![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wiz550web/sdcard/sdcard_format_warning_box.jpg)

![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wiz550web/sdcard/sdcard_format_complete.jpg)

2\. [WIZ550web GitHub repository](https://github.com/Wiznet/WIZ550web)에서
Web page demo 다운로드

![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wiz550web/sdcard/sdcard_github_clone_box.jpg)

3\. Web page demo를 Micro SD card로 복사

![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wiz550web/sdcard/sdcard_webpage_folder_merge_box.jpg)
...
![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wiz550web/wiz550webgsg/serialdebug_terminal_initial_cut.jpg)
...
![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wiz550web/wiz550webgsg/wiznet_httpserver_flowchart_v1.png)
...
![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wiz550web/wiz550webgsg/wiz550web_simple_server-client_diagram.png)
...
![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wiz550web/webpage_basicdemo/basic_demopage_1.jpg)
...
![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wiz550web/webpage_basicdemo/basic_demopage_dhcp_enabled_checked.jpg)

![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wiz550web/webpage_basicdemo/serialdebug_terminal_dhcp_checked.jpg)

### Digital I/O Status

Digital I/O Status 탭의 기본 구성은 다음과 같다.
![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wiz550web/webpage_basicdemo/basic_demopage_2.jpg)
...
출력 값을 변경할 수 있다. Digital I/O Status의 각각 I/O 정보는 다음과 같이 구성된다.
  ...
  - **Status LED Images**
    (![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wiz550web/webpage_basicdemo/dio_on.png) Blue LED /
    ![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wiz550web/webpage_basicdemo/di_on.png) Green LED /
    ![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wiz550web/webpage_basicdemo/di_off.png) Off)
...
![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wiz550web/webpage_basicdemo/basic_demopage_2_io_examples.jpg)

### ADC Status

ADC Status 탭의 기본 구성은 다음과 같다.
![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wiz550web/webpage_basicdemo/basic_demopage_3_cut.jpg)
...
![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wiz550web/webpage_basicdemo/basic_demopage_3_cut_a0_adjust_checked.jpg)

### I/O Configuration

I/O Configuration 탭의 기본 구성은 다음과 같다.
![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wiz550web/webpage_basicdemo/basic_demopage_4.jpg)
...
![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wiz550web/webpage_basicdemo/basic_demopage_4_adjust_cut.jpg)

### Serial Data

Serial Data 탭의 기본 구성은 다음과 같다.
![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wiz550web/webpage_basicdemo/basic_demopage_5_cut.jpg)

이 페이지에서는 Webpage와 UART1 간의 Serial data 입/출력 (Serial data Tx/Rx)을 확인 할 수
있다. **'Data to send'**에 'hello world\!'를 입력하고 **\[Send\]** 버튼을 누른다.

![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wiz550web/webpage_basicdemo/basic_demopage_5_cut_helloworld_checked.jpg)

Serial terminal에서 Webpage를 통해 UART1으로 전송된 문자열을 확인 할 수 있다.

![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wiz550web/webpage_basicdemo/serialdebug_terminal_helloworld_checked.jpg)

반대로, Serial terminal에서 문자열을 입력하면 **'Received data'**를 통해 확인 할 수 있다.

![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wiz550web/webpage_basicdemo/basic_demopage_5_cut_thanks_checked.jpg)
...
![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wiz550web/webpage_basicdemo/favicon_ex.jpg)
...
![](https://d3cmhcsnvv7jc.cloudfront.net/docs/img/products/wiz550web/wiz550webgsg/wiz550web_simple_requestcombination_diagram.png)
